...
const MODULES = [
  ...
  NbCardModule,
  NbChatModule,
  NbDialogModule.forChild(), // ✅ important for dialog usage
  NbIconModule,
  NbProgressBarModule,
  NbSelectModule,
  NbSpinnerModule,
...
@NgModule({
  ...
  providers: [ChatService], // ✅ make ChatService available
  exports: [
    CalendarComponent,
    InteractiveProgressBarComponent,
    DayCellComponent,
    ChatComponent, // ✅ export if you want to use chat outside this module
  ],
})
