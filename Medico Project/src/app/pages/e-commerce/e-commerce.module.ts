...
import { LinksSummaryCardComponent } from './links-summary-card/links-summary-card.component';
...
import { StatsLinksCardBackComponent } from './links-summary-card/back-side/stats-links-card-back.component';
import { CountryOrdersComponent } from './country-orders/country-orders.component';
import { StatsLinksCardFrontComponent } from './links-summary-card/front-side/stats-links-card-front.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ProfitCardComponent,
    LinksSummaryCardComponent,
    StatsLinksCardFrontComponent,
    StatsLinksCardBackComponent,
  ...
  providers: [
    ...
    DashboardService, // optional since providedIn: 'root'
  ],
})
